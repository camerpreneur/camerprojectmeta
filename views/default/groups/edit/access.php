...
?>
<div>
	<label for="groups-membership"><?php echo elgg_echo("camerproject:membership"); ?></label><br />
	<?php 
...
<?php if (elgg_get_plugin_setting("hidden_groups", "groups") == "yes"): ?>
	<div>
		<label for="groups-vis"><?php echo elgg_echo("camerproject:visibility"); ?></label><br />
		<?php
...
?>
<div>
	<label for="groups-content-access-mode"><?php echo elgg_echo("camerproject:content_access_mode"); ?></label><br />
	<?php
		echo elgg_view(
                        "input/dropdown",
